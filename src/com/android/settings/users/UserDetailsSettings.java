...
public class UserDetailsSettings extends SettingsPreferenceFragment
    ...
    private static final String KEY_DISALLOW_INSTALL_APPS_NON_GOS = "disallow_install_apps_non_gos";
    ...
    private SwitchPreference mInstallAppsNonGosPref;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        } else if (preference == mInstallAppsNonGosPref) {
            if (mUserInfo.isGuest()) {
    ...
    void initialize(Context context, Bundle arguments) {
        ...
        mInstallAppsNonGosPref = findPreference(KEY_DISALLOW_INSTALL_APPS_NON_GOS);
        ...
        if (!mUserManager.isAdminUser()) { // non admin users can't remove users and allow calls
            ...
            if (mUserInfo.isGuest()) {
                ...
                mInstallAppsNonGosPref.setChecked(mUserManager.hasUserRestriction(
            ...
            mInstallAppsNonGosPref.setOnPreferenceChangeListener(this);
        }
    }
