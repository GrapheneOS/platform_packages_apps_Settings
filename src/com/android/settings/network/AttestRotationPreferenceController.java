...
public class AttestRotationPreferenceController
    ...
    public AttestRotationPreferenceController(Context context) {
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        attestServerList.setTitle(R.string.attest_rotation_title);
        attestServerList.setSummary(R.string.attest_rotation_summary);
        attestServerList.setEntries(R.array.attest_rotation_entries);
        attestServerList.setEntryValues(R.array.attest_rotation_values);
